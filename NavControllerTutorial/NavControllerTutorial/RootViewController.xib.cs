	...
	partial class RootViewController : UITableViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			NavigationItem.RightBarButtonItem = 
				new UIBarButtonItem("Fonts", UIBarButtonItemStyle.Plain, OnFontsSelected);
			
			this.TableView.Source = new DataSource (this);
		}
		
		private void OnFontsSelected(Object o, EventArgs args)
		{
			var fontView = new FontListController();
			NavigationController.PushViewController(fontView, true);
		}
		...
		*/
		...
		class DataSource : UITableViewSource
		{
			...
			// What to put in the visible cells
			public override UITableViewCell GetCell (UITableView tableView, MonoTouch.Foundation.NSIndexPath indexPath)
			{
				...
				case 1 : cell.TextLabel.Text = "Banana"; break;
				case 2 : cell.TextLabel.Text = "Cherry"; break;
